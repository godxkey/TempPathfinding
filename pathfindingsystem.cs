...
public class PathfindingSystem : SystemBase
{
    ...
    protected override void OnUpdate()
    {
        ...
        // Some kind of permanent component with boolean
    ...
    [BurstCompile] private unsafe struct FindPathJob : IJobParallelFor
    {
        ...
        // Pathfidning map is represented as a bunch of arrays. All with "NodeLength" are the same length,
        // and same index. Many of the arrays of int2 are ranges of another 1-d array
